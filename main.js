// ─────────────────────────────────────────────────────────────
// FORMSPREE: susikurkite paskyrą formspree.io, sukurkite formą
// ir įklijuokite savo ID žemiau (vietoje "YOUR_FORM_ID").
// Nemokamame plane gaunate 50 žinučių per mėnesį.
// ─────────────────────────────────────────────────────────────
...
hamburger.addEventListener('click', () => {
  ...
  hamburger.setAttribute('aria-label', open ? 'Uždaryti meniu' : 'Meniu');
});
...
form.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (errEl) { errEl.textContent = 'Kažkas nepavyko. Rašykite tiesiogiai info@33bots.lt'; }
  }
});
